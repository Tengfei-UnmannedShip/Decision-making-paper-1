function ship_icon2( pos,a,b,course_angle,k )%中心点位置(x0,y0),长轴a，短轴b，航向角course_angle，k是船号，船号不同，颜色不同
%% 无文字标注，输入的航向角与正常的避碰算法相同，y正方向为0，顺时针计数
...
%          text(x0+0.1,y0,'ship1 OP','Color','red')
    case 2
...
%          text(x0+0.1,y0,'ship2 OP','Color','green')
    case 3
...
%          text(x0+0.1,y0,'ship3 OP','Color','blue')
    case 4
...
%          text(x0+0.1,y0,'ship4 OP','Color','black')
end
% axis ([-50 50],[-50 50])
