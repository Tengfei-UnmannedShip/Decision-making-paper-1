%% Draft2-1数据存储
for i=1:4
    DCPA_D2_1(i).record=ship(i).DCPA_Record;
    DCPA_D2_1(i).min=ship(i).DCPAmin_Record;
    
    TCPA_D2_1(i).record=ship(i).TCPA_Record;
    TCPA_D2_1(i).min=ship(i).TCPAmin_Record;
    
    Dis_D2_1(i).record=ship(i).Dis_Record;
    Dis_D2_1(i).min=ship(i).Dismin_Record;
end
save ('record(D2_1)','DCPA_D2_1','TCPA_D2_1','Dis_D2_1')
